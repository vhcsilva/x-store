...
export const products = [
  ...
  Product("T-shirt Layerx Black", 25, "layerx-black-tshirt.png", "merchandising", "t-shirt", false, 10),
  Product("Hat White X Blue", 15, "layerx-blue-hat-white.png", "merchandising", "hat", false, 5),
  ...
  Product("Bag Galaxy White", 15, "layerx-galaxy-bag.png", "merchandising", "bag", false, 5),
